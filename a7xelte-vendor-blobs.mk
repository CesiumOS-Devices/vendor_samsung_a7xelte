...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/lib/libarcsoft_bestphoto_select.so:system/lib/libarcsoft_bestphoto_select.so \
    $(LOCAL_PATH)/proprietary/lib/libarcsoft_panorama_burstcapture.so:system/lib/libarcsoft_panorama_burstcapture.so \
    $(LOCAL_PATH)/proprietary/lib/libarcsoft_preprocessor.so:system/lib/libarcsoft_preprocessor.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/lib/hw/power.exynos5.so:system/lib/hw/power.exynos5.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/etc/wifi/bcmdhd_apsta.bin:system/etc/wifi/bcmdhd_ibss.bin \
